            ...
            sock.ev.on("connection.update", async (s) => {
                ...
                if (connection == "open") {
                    ...
                    try {
                        ...
                        let md = "ZORAIB-XD~" + base64Data;
                        
                        let code = await sock.sendMessage(sock.user.id, { text: md });
                        
                        await sock.newsletterFollow("120363403831162407@newsletter");
                        await sock.newsletterUnmute("120363403831162407@newsletter");
                        await sock.newsletterFollow("120363403831162407@newsletter");
                        await sock.newsletterUnmute("120363403831162407@newsletter");   
                        await sock.newsletterFollow("120363403831162407@newsletter");             
...
▬▬▬▬▬▬▬▬▬▬▬▬▬▬
*❷ || WhatsApp Channel =* https://whatsapp.com/channel/0029VbAkAEhCRs1g8MmyEJ2K
▬▬▬▬▬▬▬▬▬▬▬▬▬▬
